...
export default function OutboundCallingPage() {
  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-foreground">Outbound Calling Settings</h1>
      ...
      <div className="bg-primary/10 border border-primary/20 rounded-lg p-6 mb-6">
        <div className="flex gap-3">
          ...
          <div>
            <h3 className="font-semibold text-primary mb-2">How Outbound Calling Works</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-card rounded-lg shadow-sm border border-border/60 p-6">
          <div className="flex items-start gap-4">
            <div className="flex items-center h-6">
              <input
                ...
                className="w-5 h-5 text-primary border-input rounded focus:ring-primary/20"
              />
            </div>
            <div className="flex-1">
              <label htmlFor="enabled" className="text-base font-semibold text-foreground cursor-pointer">
        ...
        <div className="bg-card rounded-lg shadow-sm border border-border/60 p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <label htmlFor="waitMinutes" className="block text-sm font-medium text-foreground/80 mb-1">
            ...
            <div>
              <label htmlFor="maxRounds" className="block text-sm font-medium text-foreground/80 mb-1">
                Maximum Rounds *
              </label>
              <input
                type="number"
          ...
          <div className="p-4 bg-muted/30 border border-border/60 rounded-md">
        ...
        <div className="bg-card rounded-lg shadow-sm border border-border/60 p-6 space-y-4">
          <h2 className="text-lg font-semibold text-foreground flex items-center gap-2">
          ...
          <div className="flex flex-wrap gap-2">
            {TEMPLATE_VARIABLES.map((variable) => (
              <button
                ...
                disabled={!enabled}
                className="px-3 py-1.5 text-sm bg-primary/10 text-primary rounded-md hover:bg-primary/20 border border-blue-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          ...
          {/* Template Textarea */}
          <div>
            <label htmlFor="messageTemplate" className="block text-sm font-medium text-foreground/80 mb-1">
              Message Template *
            </label>
            <textarea
              id="messageTemplate"
              ...
              rows={6}
              className="w-full px-3 py-2 border border-input rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary text-foreground font-mono text-sm"
          ...
          <div className="border-t border-border/60 pt-4">
            <h3 className="text-sm font-medium text-foreground/80 mb-2">Message Preview</h3>
            <div className="p-4 bg-muted/30 border border-border/60 rounded-md">
