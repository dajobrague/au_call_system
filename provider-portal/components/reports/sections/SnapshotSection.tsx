    ...
    <div className="bg-card border border-input rounded-lg p-6 mb-6 print:border-black">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <div className="flex items-start gap-3">
          <div className="shrink-0 w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center print:bg-muted">
            <Phone className="w-5 h-5 text-primary print:text-black" />
          </div>
          <div>
